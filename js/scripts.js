$(document).ready(function() {
  ...
  if (urlQueryString.has('uuid')) {
    ...
    $('#rsvp-form').on('submit', function(e) {
      ...
      const md5_hash_array = ["aaef5aa7d10f30229301121f2af79686",
      ...
      $.post('https://script.google.com/macros/s/AKfycbwhj-x5xU3nlfLu3FPLP6TUb7VHKBYkKPSa7vWWN0vKDQBMoHRpa9vC0OmGDSU06Qg6tw/exec', formData)
        .done(function(returnData) {
          ...
          switch (returnData.result) {
            case 'error':
              ...
              break;
            case 'warning':
              $('#alert-wrapper').html(alert_markup('warning', returnData.message));
              console.log(returnData);
...
function AddAGuest(initSupportFunctions = true, guestLimit = 10) {
  ...
  <div class="form-input-group multi-input-group guests" id="guestGroup___${guestCount}">
    ...
    <div class="row collapse in section-title" aria-expanded="true" id="guestDiv___${guestCount}">
      ...
      <div class="col-xs-12 col-lg-6">
        <div data-toggle="popover" data-trigger="hover focus" data-delay='{ "show": 200, "hide": 350 }' title="Meals <a class='close' href='#'>&times;</a>" data-placement="auto bottom" data-html="true"
        data-content="We are hoping to have the children's meals served around 5pm, while the Adults are picking at the grazing table.<br /><br /><strong>Parents of young ones:</strong> please let us know your thoughts, and whether you're intending to stay for the main meal.<br /><br />We're planning for the Adult's main course to be served around 6:30pm.">
          <div class="form-input-group">
            <i class="fa fa-cutlery fa-lg"></i>
            <select name="meal_type___${guestCount}" class="" placeholder="Meal type" required>
...
function alert_markup(alert_type, msg) {
  return '<div class="alert alert-' + alert_type + '  fade in" role="alert" alert-dismissable><button type="button" class="close" data-dismiss="alert" aria-label="Close"><span aria-hidden="true">&times;</span></button>' + msg + '</div>';
}
